...
| User List | Detail View | Search | Empty State |
|:---------:|:-----------:|:------:|:-----------:|
| ![User list](docs/screenshots/01-user-list-stub.png) | ![Detail view](docs/screenshots/02-user-detail.png) | ![Search results](docs/screenshots/03-search-results.png) | ![Empty state](docs/screenshots/04-search-empty.png) |
